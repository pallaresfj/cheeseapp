  ...
  <body>
    ...
    <section id="home" class="hero-section-wrapper hero-section-wrapper-1">
      ...
      <div class="hero-section hero-style-1">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="hero-content-wrapper">
                <h2>CheeseApp</h2>
                <p>Tu aplicación web para la gestión de tu transformadora de lácteos.</p>
                  <a href="/admin/login" rel="nofollow" target="_blank" class="button button-lg radius-50">Ingresar</a>
              </div>
            </div>
        ...
        <div class="shapes">
          <img src="{{ asset('assets/img/hero/hero-1/shape-1.svg') }}" alt="" class="shape shape-1">
          <img src="{{ asset('assets/img/hero/hero-1/shape-2.svg') }}" alt="" class="shape shape-2">
          <img src="{{ asset('assets/img/hero/hero-1/shape-3.svg') }}" alt="" class="shape shape-3">
          <img src="{{ asset('assets/img/hero/hero-1/shape-4.svg') }}" alt="" class="shape shape-4">
        </div>
      </div>
      <!-- ========================= hero-1 end ========================= -->
    </section>
    ...
    <!-- ========================= about style-5 start ========================= -->
    <section id="about" class="about-section about-style-5" style="background-image: url('{{ asset('assets/img/about/about-5/about-img.jpg') }}')">
      <div class="container">
        <div class="row">
