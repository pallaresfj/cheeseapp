                ...
                <nav class="navbar navbar-expand-lg">
                  ...
                  <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent4">
                    <ul id="nav4" class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        <a class="page-scroll active" href="/contact">Contacto</a>
                      </li>
                    </ul>
        ...
        <div class="row justify-content-center">
          <div class="col-xxl-5 col-xl-5 col-lg-7 col-md-10">
            <div class="section-title text-center mb-50">
              <h3 class="mb-15">Ponte en Contacto</h3>
            ...
            <div class="contact-form-wrapper">
              <form action="assets/php/contact.php" method="POST">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="single-input">
                      <input type="text" id="number" name="number" class="form-input" placeholder="Teléfono">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-6">
                  <div class="single-item">
                    ...
                    <div class="text">
                      <p>pallaresfj@gmail.com</p>
                      <p>pallaresfj@asyservicios.com</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-12 col-md-6">
                  <div class="single-item">
                    ...
                    <div class="text">
                      <p>AS&Servicios, Calle 3A 6 16, Sabanas Magdalena</p>
                    </div>
                  </div>
                </div>
              </div>
